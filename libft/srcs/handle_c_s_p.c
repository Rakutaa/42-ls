...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/26 15:37:37 by vtran             #+#    #+#             */
/*   Updated: 2020/01/31 15:39:13 by vtran            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			pointer(t_print **p)
{
	...
	if (tmp->ppad > len)
		str = ft_strjoin_f(str, ft_memset(ft_strnew(tmp->ppad - len),
						'0', tmp->ppad - len));
	if (!((*p)->ppad == 0 && tmp->flags & F_DOT && ft_atoi(temp) == 0))
		str = ft_strjoin_f(str, temp);
